...
export default async function handler(req, res) {
  ...
  const publicKey = process.env.TRKIT_PUBLIC_KEY || process.env.TRIPKIT_PUBLIC_KEY
  ...
  if (!secretKey || !publicKey) {
    return json(res, 500, {
      ...
      expectedEnv: {
        secretKey: ["TRKIT_SECRET_KEY", "TRIPKIT_SECRET_KEY"],
        publicKey: ["TRKIT_PUBLIC_KEY", "TRIPKIT_PUBLIC_KEY"],
      },
    })
  }
